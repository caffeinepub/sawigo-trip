...
export class Backend implements backendInterface {
    ...
    async createBlogPost(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<void> {
    ...
    async getAllInquiries(): Promise<Array<TripInquiry>> {
        if (this.processError) {
            try {
    ...
    async submitInquiry(arg0: TripInquiry): Promise<void> {
        if (this.processError) {
            try {
